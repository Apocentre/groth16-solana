...
mod tests {
    ...
    fn proof_verification_should_succeed() {
        ...
        let mut prepared_public_inputs = prepare_inputs(
          &VERIFYING_KEY,
          None,
          vec![PUBLIC_INPUTS[0], PUBLIC_INPUTS[1], PUBLIC_INPUTS[2], PUBLIC_INPUTS[3]],
          0,
        ).unwrap();
        ...
        prepared_public_inputs = prepare_inputs(
          ...
          vec![PUBLIC_INPUTS[4], PUBLIC_INPUTS[5], PUBLIC_INPUTS[6], PUBLIC_INPUTS[7]],
          4,
        ).unwrap();
        ...
        let mut verifier =
            Groth16Verifier::new(&proof_a, &proof_b, &proof_c, prepared_public_inputs, &VERIFYING_KEY)
                .unwrap();
